...
<div class="embedded-event border-2 border-gray-300 rounded-2xl p-6 my-6 bg-white shadow-lg hover:shadow-xl transition-all duration-300 max-w-5xl mx-auto">
  {#if loading}
