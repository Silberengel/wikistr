...
<div class="flex overflow-x-auto overflow-y-hidden pb-2 pr-4" draggable="false" bind:this={slider} data-theme={theme.name} data-mode={currentMode} style="scroll-behavior: smooth;">
